...
<html lang="es">
	...
	<script>
		...
		if (tipoUsuario == "orquestador" || tipoUsuario == "supervisor"){
			window.location = 'user-assigned-ticket'
		}
	</script>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="welcome-backgr header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
		<!--begin::Main-->
		<!--begin::Root-->
				...
				<!--------------------------------------------------------------------------------------------------------------------------------------Notificaciones y user info-->
					...
					<div class="d-flex flex-column flex-lg-row-fluid py-10 global-form">
						...
						<div class="d-flex flex-center flex-column flex-column-fluid">
                            <!--begin::Wrapper-->
                            <div class="w-lg-1000px p-10 p-lg-15 mx-auto rounded login-shadow login-login" id="kt_dashboard" hidden>
                                <!--begin::Form-->
                                <form class="form w-1000 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_new_dashboard" action="#">
									...
									<div class="text-center mb-10">
										<a href="#" class="text-dark text-hover-primary fw-bolder fs-3"></a>
											<div class="text-muted fs-2 fw-bold ">Bienvenido/a</div>
												<p></p>
												<div class="text-muted fs-7 fw-bold ">Elija una opción de nuestro menú superior para comenzar a trabajar.</div>
												<br></br>
												<table class="table">
													<thead>
														<tr>
														...
														<tr>
															<td class="col-sm-6 col-md-7">
																<div class="row align-items-center text-center">
																	<img alt="Logo" src="assets/media/illustrations/sketchy-1/team.png"/>
																</div>
															</td>
															<td class="col-sm-6 col-md-7">
																<div class="row align-items-center text-center">
																	<div id="chart-container-welcome"></div>
																</div>
															</td>
														</tr>
													</tbody>
		...
		<script src="assets/js/custom/index/index.js?v=<?php echo(rand()); ?>"></script>
