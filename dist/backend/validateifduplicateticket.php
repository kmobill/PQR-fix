<?php
    ...
    $cedulatk = $_POST['cedulatk'];
    $productotk = $_POST['productotk'];
    $tincidenciatk = $_POST['tincidenciatk'];
    $stincidenciatk = $_POST['stincidenciatk'];
    ...
    $query0 = "
        select 
            ...
            statet
        from gestiontickets
        where cedula = '" .$cedulatk. "'
            and producto = '" .$productotk. "'
            and tipoincidencia = '" .$tincidenciatk. "'
            and stincidencia = '" .$stincidenciatk. "'
	    and statet in ('ABIERTO','EN PROCESO')
    ";
