...
<html lang="es">
	...
	<body id="kt_body" class="all-body-bg header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
				...
				<!--------------------------------------------------------------------------------------------------------------------------------------Notificaciones y user info-->
					...
					<div class="d-flex flex-column flex-lg-row-fluid py-10 global-form">
						...
						<div class="d-flex flex-center flex-column flex-column-fluid">
                            <!--begin::Wrapper-->
                            <div class="w-lg-1000px p-10 p-lg-15 mx-auto rounded login-shadow login-login" id="kt_new_ticket_2">
								<!--begin::Form-->
								<form class="form w-1000" novalidate="novalidate" id="kt_create_rol_form" action="#">
									<!--begin::mini header-->
									<div class="bg-mini-header">
										...
										<div class="text-left">
											<!--begin::Title-->
											<h1 class="mb-3" style="color: #FFFFFF;">Lista de roles</h1>
											<!--end::Title-->
										</div>
										<!--end::Heading-->
									</div>
                                    ...
                                    <div class="text-center mb-10">
										<p>
											<br><h6 class="mb-3" style="color: #00235E;">Se muestra la lista de roles en el sistema, si desea agregar uno nuevo de clic en el botón crear</h6></br>
										</p>
									</div>
                                    <!--end::Input group-->
									<!--begin::Input group-->
									<div class="fv-row mb-10">
										<!--begin::Wrapper-->
										<!--begin::Table-->
										<table class="table table-bordered nowrap table-responsive responsive" id="datatable-ajax-list-profiles" style="width:100%">
									...
									<div class="text-center">
										<!--begin::Submit button-->
										<button type="button" id="kt_create_rol_submit" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="btn btn-lg login-btnblue fw-bolder me-4">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!--begin::Wrapper-->
                                            <div class="w-lg-700px p-10 p-lg-15 mx-auto rounded login-login" id="kt_new_rol_form_global">
                                                <form class="form w-700" novalidate="novalidate" id="kt_new_user_form" action="#">
                                                    <!--begin::Input group-->
                                                    <div class="fv-row mb-10">
                                                        <label class="form-label fs-6 fw-bolder text-dark">Nombre de rol *</label>
                                                        <input class="form-control form-control-lg" type="input" name="new-type-profile" id="new-type-profile" autocomplete="off" />
                                                    </div>
													<!--begin::Input group-->
													<div class="fv-row mb-10">
														<!--begin::Label-->
														<label class="form-label fs-6 fw-bolder text-dark">Nivel *</label>
														<!--end::Label-->
														<!--begin::select-->
														<select class="form-control form-control-lg form-select" name="new-level-profile" id="new-level-profile" autocomplete="off">
                                                    ...
                                                    <!--begin::Action-->
                                                    <div class="text-center">
                                                        <button type="button" id="kt_new_rol_submit" class="btn btn-lg login-btnblue fw-bolder">
                                                            <span class="indicator-label">Continuar</span>
                                                            <span class="indicator-progress">Un momento por favor...
                                                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                                        </button>
                                                        <a id="kt_cancel_new_rol" class="btn btn-lg border" data-bs-dismiss="modal">Cancelar</a>
                                                    </div>
                                                    <!--end::Action-->
                                                </form>
                                                <!--end::Form-->
		...
		<script src="assets/js/custom/authentication/user-access/list-profile.js?v=<?php echo(rand()); ?>"></script>
