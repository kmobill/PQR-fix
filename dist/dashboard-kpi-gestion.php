                                ...
                                <form class="form w-1000 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_new_dashboard" action="#">
									...
									<div class="text-center mb-10">
										<a href="#" class="text-dark text-hover-primary fw-bolder fs-3"></a>
											<div class="text-muted fs-2 fw-bold ">KPI's de Gestión</div>
                                            <p></p>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <td class="col-6">
                                                            <div class="text-muted fs-7 fw-bold ">Ratio de PQR's <i class="fa fa-retweet dashpointer" id="dash1refresh" aria-hidden="true"></i></div>
                                                            <div class="row align-items-center text-center">
                                                                <div id="chart-container"></div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="text-muted fs-7 fw-bold ">Eficiencia <i class="fa fa-retweet dashpointer" id="dash2refresh" aria-hidden="true"></i></div>
                                                            <div class="row align-items-center text-center">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="text-muted fs-7 fw-bold ">Tasa de escalamiento <i class="fa fa-retweet dashpointer" id="dash3refresh" aria-hidden="true"></i></div>
                                                            <div class="row align-items-center text-center">
                                                                <div id="chart-container2"></div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="text-muted fs-7 fw-bold ">TMO <i class="fa fa-retweet dashpointer" id="dash4refresh" aria-hidden="true"></i></div>
                                                            <div class="row align-items-center text-center">
