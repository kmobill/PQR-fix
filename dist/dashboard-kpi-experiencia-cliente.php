...
<html lang="es">
	...
	<body id="kt_body" class="all-body-bg header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
                                ...
                                <form class="form w-1000 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_new_dashboard" action="#">
									...
									<div class="text-center mb-10">
										<a href="#" class="text-dark text-hover-primary fw-bolder fs-3"></a>
											<div class="text-muted fs-2 fw-bold ">KPI's experiencia de cliente <i class="fa fa-retweet dashpointer" id="dash1refresh" aria-hidden="true"></i></div>
                                            <p></p>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div class="col-auto input-group-sm">
                                                                    <input required min=<?php $antes=date("Y-m-d", strtotime("-720 hour")); echo $antes;?> required max=<?php $hoy=date("Y-m-d"); echo $hoy;?> class="form-control" type="date" name="fechainicioticket1" id="fechainicioticket1" autocomplete="off"/>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <label class="col-form-label">Fecha fin</label>
                                                                </div>
                                                                <div class="col-auto input-group-sm">
                                                                    <input required min=<?php $antes=date("Y-m-d", strtotime("-720 hour")); echo $antes;?> required max=<?php $hoy=date("Y-m-d"); echo $hoy;?> class="form-control" type="date" name="fechafinticket1" id="fechafinticket1" autocomplete="off"/>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <td class="col-6">
                                                            <div class="text-muted fs-7 fw-bold ">FCR</div>
                                                            <div class="row align-items-center text-center">
                                                                <div id="chart-container"></div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="text-muted fs-7 fw-bold ">Comentarios FCR</div>
                                                            <table class="table table-sm table-borderless table-hover" id="datatable-detail-fcr-no" style="width:100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="text-muted fs-7 fw-bold ">NPS</div>
                                                            <div class="row align-items-center text-center">
                                                                <div id="chart-container2"></div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                        <div class="text-muted fs-7 fw-bold ">Comentarios NPS</div>
                                                            <table class="table table-sm table-borderless table-hover" id="datatable-detail-nps" style="width:100%">
																<thead thead-dark></thead>
																<tbody></tbody>
															</table>
                                                        </td>
		...
		<script src="assets/js/custom/index/dashboard-kpi-experiencia-cliente.js?v=<?php echo(rand()); ?>"></script>
