							...
							<form class="fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_new_dashboard" action="#">
								...
								<div class="text-center mb-10">
									...
									<div class="titles-form">
										<h1>KPI's experiencia de cliente <i class="fa fa-retweet dashpointer iconoForm" id="dash1refresh" aria-hidden="true"></i></h1>
									</div>
											...
											<tbody>
												<tr>
													<td>
														...
														<div class="col-auto input-group-sm  mx-auto" style="max-width: 300px;">
															<input required min=<?php $antes = date("Y-m-d", strtotime("-720 hour"));
																									echo $antes; ?> required max=<?php $hoy = date("Y-m-d");
																																								echo $hoy; ?> class="form-control" type="date" name="fechainicioticket1" id="fechainicioticket1" autocomplete="off" />
														</div>
														<div class="col-auto">
														...
														<div class="col-auto input-group-sm mx-auto" style="max-width: 300px;">
															<input required min=<?php $antes = date("Y-m-d", strtotime("-720 hour"));
																									echo $antes; ?> required max=<?php $hoy = date("Y-m-d");
																																								echo $hoy; ?> class="form-control" type="date" name="fechafinticket1" id="fechafinticket1" autocomplete="off" />
														</div>
													</td>
												</tr>
											</tbody>
									...
									<table class="table">
										<tbody>
											<tr>
												<td class="col-6">
													<div class="titles-form">
														<h2 class="text-muted fs-7 fw-bold ">FCR</h2>
													</div>
													<div class="row align-items-center text-center">
														<div id="chart-container"></div>
													</div>
												</td>
												<td class="message-container" style="height: 446px;">
													<div class="titles-form">
														<h2>Comentarios FRC</h2>
													</div>
											...
											<tr>
												...
												<td class="message-container" style="height: 366px;">
													<div class="titles-form">
														<h2>Comentarios NPS</h2>
													</div>
													<section class="message-content">
