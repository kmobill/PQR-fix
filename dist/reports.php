...
<html lang="es">
	...
	<body id="kt_body" class="all-body-bg header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
				...
				<!--------------------------------------------------------------------------------------------------------------------------------------Notificaciones y user info-->
					...
					<div class="d-flex flex-column flex-lg-row-fluid py-10 global-form">
						...
						<div class="d-flex flex-center flex-column flex-column-fluid">
                            <!--begin::Wrapper-->
                            <div class="w-lg-1000px p-10 p-lg-15 mx-auto rounded login-shadow login-login" id="kt_reports">
								<!--begin::Form-->
								<form class="form w-1000" novalidate="novalidate" id="kt_reports_form" action="#">
									<!--begin::mini header-->
									<div class="bg-mini-header">
										...
										<div class="text-left">
											<!--begin::Title-->
											<h1 class="mb-3" style="color: #FFFFFF;">Reportes</h1>
											<!--end::Title-->
										</div>
										<!--end::Heading-->
									</div>
                                    ...
                                    <div class="text-center mb-10">
										<p>
											<br><h6 class="mb-3" style="color: #00235E;">Por favor, seleccione el reporte que desea visualizar y extraer</h6></br>
										</p>
									</div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
									<div class="fv-row mb-10">
										<!--begin::Label-->
										<label class="form-label fs-6 fw-bolder text-dark">Tipo reporte *</label>
										<!--end::Label-->
										<!--begin::select-->
										<select class="form-select form-select-sm" name="tiporeporte" id="tiporeporte" autocomplete="off">
											<option selected disabled></option>
											<option value="ultimagestion">Última gestión</option>
                                    ...
                                    <div class="fv-row mb-10">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <!--end::Wrapper-->
                                                        <!--begin::Input-->
                                                        <input required max=<?php $hoy=date("Y-m-d"); echo $hoy;?> class="form-control form-control-sm" type="date" name="fechainicioticket" id="fechainicioticket" autocomplete="off"/>
                                                        <!--end::Input-->
                                                    </td>
                                                    <td> 
                                                        <!--begin::Wrapper-->
                                                        ...
                                                        <!--end::Wrapper-->
                                                        <!--begin::Input-->
                                                        <input required max=<?php $hoy=date("Y-m-d"); echo $hoy;?> class="form-control form-control-sm" type="date" name="fechafinticket" id="fechafinticket" autocomplete="off"/>
                                                        <!--end::Input-->
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-flex flex-stack mb-2">
                                                            <!--begin::Label-->
                                                            <label class="form-label fw-bolder text-dark fs-6 mb-0">Asesor</label>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Wrapper-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-sm" type="input" name="reporteagente" id="reporteagente" autocomplete="off"/>
                                                        <!--end::Input-->
                                                    </td>
                                                    <td>
                                                        <!--begin::Wrapper-->
                                                        <div class="d-flex flex-stack mb-2">
                                                            <!--begin::Label-->
                                                            <label class="form-label fw-bolder text-dark fs-6 mb-0">Estado ticket</label>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Wrapper-->
                                                        <!--begin::select-->
                                                        <select class="form-select form-select-sm" name="reporteestado" id="reporteestado" autocomplete="off">
                                                            <option selected disabled></option>
												...
												<tr>
                                                    <td>
                                                        ...
                                                        <!--end::Wrapper-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-sm" type="input" name="reporteticket" id="reporteticket" autocomplete="off"/>
                                                        <!--end::Input-->
                                                    </td>
                                                    <td>
                                                        <!--begin::Wrapper-->
                                                        <div class="d-flex flex-stack mb-2">
                                                            <!--begin::Label-->
                                                            <label class="form-label fw-bolder text-dark fs-6 mb-0">Identificación</label>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Wrapper-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-sm" type="input" name="reporteidentificacion" id="reporteidentificacion" autocomplete="off"/>
                                                        <!--end::Input-->
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <div class="text-center">
                                            <!--begin::Submit button-->
                                            <button type="submit" id="kt_reports_submit" class="btn btn-lg login-btnblue fw-bolder me-4">
								...
								<form class="form w-1000" novalidate="novalidate" action="#">
									...
									<div class="fv-row mb-10">
										<!--begin::Wrapper-->
										<!--begin::Table-->
										<table class="table table-bordered nowrap table-responsive responsive" id="datatable-ajax-report" style="width:100%">
		...
		<script src="assets/js/custom/authentication/reports/reports.js?v=<?php echo(rand()); ?>"></script>
