                            ...
                            <div class="w-lg-1000px p-10 p-lg-15 mx-auto rounded login-shadow login-login" id="kt_new_ticket_1">
                                ...
                                <form class="form w-1000" novalidate="novalidate" id="kt_client_access_form" action="#">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <label class="form-label fs-6 fw-bolder text-dark col-sm-3 col-form-label col-sm-3 col-form-label" for="cedulacliente">Cédula cliente *</label>
											<div class="col-sm-9">
												<div class="input-group mb-3">
													<input class="form-control form-control-lg" type="number" placeholder="Ingrese la cédula del cliente" name="cedulacliente" id="cedulacliente" autocomplete="off" />
								...
								<form class="form w-1000" novalidate="novalidate" id="kt_new_ticket_form" action="#">
									...
									<div class="fv-row mb-10">
										<div class="form-group row">
											<label for="tipoarea" class="form-label fs-6 fw-bolder text-dark col-sm-3 col-form-label">Área *</label>
											<div class="col-sm-9">
