...
<html lang="es">
	...
	<body id="kt_body" style="background-image: url(assets/media/patterns/header-bg-dark.png)" class="login-body header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
													...
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="d-flex flex-column">
															<div class="fw-bolder d-flex align-items-center fs-5">
																<label id="name-profile">Mejia Ayala Jose Gabriel</label>
															</div>
															<a id="usertype-profile" class="fw-bold text-muted text-hover-primary fs-7">Super User</a>
															<a id="mail-profile" class="fw-bold text-muted text-hover-primary fs-9">sertecmega@gmail.com</a>
														</div>
														<!--end::Username-->
													</div>
												</div>
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="page-title d-flex flex-column me-3">
								<!--begin::Title-->
								<h1 class="d-flex text-white fw-bolder my-1 fs-3">Usuarios</h1>
								<!--end::Title-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
									<!--begin::Item-->
									<li class="breadcrumb-item text-white opacity-75">
										<a class="text-white text-hover-primary">Usuarios</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
									...
									<!--end::Item-->
									<!--begin::Item-->
									<li class="breadcrumb-item text-white opacity-75 text-white text-hover-primary">Nuevo usuario</li>
									<!--end::Item-->
								</ul>
								<!--end::Breadcrumb-->
							</div>
					...
					<div class="d-flex flex-column flex-lg-row-fluid py-10 global-form">
						...
						<div class="d-flex flex-center flex-column flex-column-fluid">
							<!--begin::Wrapper-->
							<div class="w-lg-700px p-10 p-lg-15 mx-auto rounded login-shadow login-login" id="kt_new_user_form_global">
								<form class="form w-700" novalidate="novalidate" id="kt_new_user_form" action="#">
									...
									<div class="text-center mb-10">
										<!--begin::Title-->
										<h2 class="mb-3" style="color: #00235E;">Nuevo usuario</h2>
										<p>
											<br><h8 class="mb-3" style="color: #00235E;">Por favor, ingrese los datos a continuación para crear al nuevo usuario</h8></br>
										</p>
										<!--end::Title-->
									</div>
									<!--end::Heading-->
									...
									<div class="fv-row mb-10" id="areaglb">
										<label class="form-label fs-6 fw-bolder text-dark">Area *</label>
										<!--begin::select-->
									...
									<div class="text-center">
										<button type="button" id="kt_new_user_submit" class="btn btn-lg login-btnblue fw-bolder">
		...
		<script src="assets/js/custom/authentication/user-access/new-user.js?v=<?php echo(rand()); ?>"></script>
