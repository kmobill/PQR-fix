						...
						<div class="w-lg-1000px p-10 p-lg-15 mx-auto rounded login-shadow login-login" id="kt_new_ticket_1">
							...
							<form class="form w-1000" novalidate="novalidate" id="kt_search_ticket_form" action="#">
								...
								<div class="text-center mb-10">
									<p>
										<br>
									<h6 class="mb-3" style="color: #00235E;">Por favor, registre la información que se muestra a continuación</h6></br>
									</p>
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								...
								<div class="fv-row mb-10" id="por-cedula" hidden>
									...
									<!--end::Wrapper-->
									<!--begin::Input-->
									<input class="form-control form-control-lg" type="text" name="cedulaticket" id="cedulaticket" autocomplete="off" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
