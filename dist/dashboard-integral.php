							...
							<form class="fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_new_dashboard" action="#">
								...
								<div class="text-center mb-10">
									...
									<div class="titles-form">
										...
										<h2>Incidencias <i class="fa fa-retweet dashpointer iconoForm" id="dash1refresh" aria-hidden="true"></i></h2>
									</div>
									<table class="table">
										<thead>
											<tr>
												...
												<td>
														...
														<div class="col-auto input-group-sm">
															<input required min=<?php $antes = date("Y-m-d", strtotime("-720 hour"));
																									echo $antes; ?> required max=<?php $hoy = date("Y-m-d");
																																								echo $hoy; ?> class="form-control" type="date" name="fechainicioticket" id="fechainicioticket" autocomplete="off" />
														</div>
														<div class="col-auto">
													...
													<div class="row">
														<div class="col-auto input-group-sm">
															<input required min=<?php $antes = date("Y-m-d", strtotime("-720 hour"));
																									echo $antes; ?> required max=<?php $hoy = date("Y-m-d");
																																								echo $hoy; ?> class="form-control" type="date" name="fechafinticket" id="fechafinticket" autocomplete="off" />
														</div>
														<div class="col-auto">
									...
									<p></p>
									<div class="titles-form">
										<h2>Analitica de Incidencias <i class="fa fa-retweet dashpointer iconoForm" id="dash2refresh" aria-hidden="true"></i></h2>
									</div>
									<br></br>
									<table class="table">
										<thead>
