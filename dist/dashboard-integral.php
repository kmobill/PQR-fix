...
<html lang="es">
	...
	<body id="kt_body" class="all-body-bg header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
                                ...
                                <form class="form w-1000 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_new_dashboard" action="#">
									...
									<div class="text-center mb-10">
										<a href="#" class="text-dark text-hover-primary fw-bolder fs-3"></a>
											<div class="text-muted fs-2 fw-bold ">Dashboard Integral</div>
                                            <p></p>
                                            <div class="text-muted fs-7 fw-bold ">Incidencias <i class="fa fa-retweet dashpointer" id="dash1refresh" aria-hidden="true"></i></div>
                                            <br></br>
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-auto">
                                                                    <select class="form-select form-select-sm" name="slaproducto" id="slaproducto" autocomplete="off">
                                            ...
                                            <p></p>
                                            <div class="text-muted fs-7 fw-bold ">Analitica de Incidencias <i class="fa fa-retweet dashpointer" id="dash2refresh" aria-hidden="true"></i></div>
                                            <br></br>
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td class="col-sm-6 col-md-7">
                                                            <div class="row align-items-center text-center">
                                                                <div id="chart-container1">
                                                                    <canvas id="chartenproceso"></canvas>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
		...
		<script src="assets/js/custom/index/dashboard-integral.js?v=<?php echo(rand()); ?>"></script>
	</body>
</html>
