...
$("#dash1refresh").click(function(){
    ...
    $.ajax({
        ...
        data: {
            fechainicio: (dash1fecinicio == "" || dash1fecinicio == null)?"1900-01-01":dash1fecinicio,
            fechafin: (dash1fecfin == "" || dash1fecfin == null)?obtenerFecha():dash1fecfin,
            producto: (dash1producto == "" || dash1producto == null)?"":dash1producto,
            incidencia: (dash1incidencia == "" || dash1incidencia == null)?"":dash1incidencia
        },
        method: "POST",
        dataType: "JSON",
        success: function(data){
            Highcharts.chart('chart-container', {
                ...
                exporting: {
                    buttons: {
                        contextButton: {
                            menuItems: ['printChart','seprator', 'downloadXLS', 'downloadCSV','separator','downloadPNG', 'downloadJPEG', 'downloadPDF']
                        }
                    }
                },
                lang: {
...
$("#dash2refresh").click(function(){
    ...
    $.ajax({
        ...
        data: {
            fechainicio: (dash2fecinicio == "" || dash2fecinicio == null)?"1900-01-01":dash2fecinicio,
            fechafin: (dash2fecfin == "" || dash2fecfin == null)?obtenerFecha():dash2fecfin,
            producto: (dash1producto == "" || dash1producto == null)?"":dash1producto,
            incidencia: (dash1incidencia == "" || dash1incidencia == null)?"":dash1incidencia
        },
        method: "POST",
