...
$("#dash1refresh").click(function(){
    ...
    dash1incidencia = ""
    $.ajax({
        url: "backend/dashboardincidencetype.php?action=inicio",
        data: {
...
$("#fechafinticket").change(function(){
    ...
    $.ajax({
        url: "backend/dashboardincidencetype.php?action=fechas",
        data: {
            fechainicio: (dash1fecinicio == "" || dash1fecinicio == null)?"1900-01-01":dash1fecinicio,
            fechafin: (dash1fecfin == "" || dash1fecfin == null)?obtenerFecha():dash1fecfin,
            incidencia: (dash1incidencia == "" || dash1incidencia == null)?"":dash1incidencia
...
$("#slaincidencia").change(function(){
    ...
    $.ajax({
        url: "backend/dashboardincidencetype.php?action=incidencias",
        data: {
            fechainicio: (dash1fecinicio == "" || dash1fecinicio == null)?"1900-01-01":dash1fecinicio,
            fechafin: (dash1fecfin == "" || dash1fecfin == null)?obtenerFecha():dash1fecfin,
            incidencia: (dash1incidencia == "" || dash1incidencia == null)?"":dash1incidencia
