...
window.onload = function(){
    ...
    $("#maxuploadcant").text("Cargar archivos o captura de pantalla (Max. " + maxuploadfile + " archivos / Max. 1.5Mb por archivo / Max. 4Mb en general )")
        ...
        init:function(){
            ...
            e.addEventListener("click",(function(o){
                ...
                if (!validarcedula(cedcliente)){
                    ...
                    i.validate().then(
                        (function(i){
                            var usercedula = t.querySelector('[name="cedulacliente"]').value
                            "Valid" == i?(
                                ...
                                setTimeout((function(){
                                    ...
                                    $.post('backend/getclient.php',{
                                        ...
                                        if (existe == "No"){
                                            ...
                                            $("#nombrecliente").attr("placeholder","Ingrese el nombre del cliente")
                                            $("#correocliente").attr("placeholder","Ingrese el correo del cliente")
                                            $("#celularcliente").attr("placeholder","Ingrese el celular del cliente")
                                            $("#nombrecliente").focus()
                                        ...
                                        $("#kt_client_access_submit").attr("disabled","disabled")
                                    })
                                }),1500)
                            ):Swal.fire({
            ...
            e.addEventListener("click",(function(n){
                ...
                i.validate().then((function(i){
                    ...
                    "Valid" == i?(
   				    ...
   				    var Body1 = "<img src='https://drive.google.com/uc?export=view&id=1NrznwHX3fHC_GdO7ph-hmxzM6KdFMRnM' alt='generado-ticket' border='0'>"
...
$("#subtipoincidencia").change(function(){
	...
	var vCedulaTK = parseData.data[0][0]
		...
		var mensaje = "Ya existe un ticket con los mismos datos para el cliente " + vCedulaTK + " " + vNombresTK + ", con identificador " + vTicketIdTK + ", en estado " + vStateTK + "... debe seleccionar otros datos para continuar"
                Swal.fire({
                    text: mensaje,
                    icon: "warning",
                    buttonsStyling: !1,
