                            ...
                            dtajax = $("#datatable-ajax").DataTable({
                                ...
                                ajax:{
                                    ...
                                    data: {
                                        ...
                                        profileid: (profileid == "" || profileid == undefined)?"No aplica":profileid,
...
$('#datatable-ajax tbody').on('click', 'td.details-control', function(){
    ...
    if (row.child.isShown()){
        ...
        row.child(format(cedula, mail, phone, producto, tincidencia, stincidencia, area, trespuesta, creadop, aasignado)).show()
        tr.addClass('shown')
    }
} );
...
function format(cedula, mail, phone, producto, tincidencia, stincidencia, area, trespuesta, creadop, aasignado){
