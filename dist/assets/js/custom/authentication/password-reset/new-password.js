                    ...
                    $.post("backend/getcodetemp.php", {
                      ...
                      if (ingcode == codigo) {
                        Swal.fire({
                          ...
                          $("#kt_sing_in_two_steps_form").attr(
                            "hidden",
                            "hidden"
                          );
            ...
            "confirm-password": {
              validators: {
                ...
                identical: {
                  ...
                  message:
                    "La confirmación de contraseña no es igual a la ingresada anteriormente",
                },
              },
            },
            /* toc: {
                        ...
                        if (parseData == "OK") {
                          Swal.fire({
                            ...
                            t.isConfirmed &&
                              ...
                              o.reset());
                            window.location =
                              "authentication/flows/aside/sign-in";
                          });
                        } else {
                          Swal.fire({
...
function temporizador_codigo(duration, element) {
  ...
  countInterval = setInterval(function () {
    ...
    element.textContent = `El código expira en ${paddedFormat(
      min
    )}:${paddedFormat(sec)}`;
...
window.onload = function () {
  ...
  if (isdefaultpasswd == "1") {
    ...
    $("#newpasswdenunc").text(
      "Estimado " +
        uname +
        ", debe modificar su contraseña de acuerdo a lo solicitado."
    );
  } else {
    $("#kt_sing_in_two_steps_form").removeAttr("hidden");
    $("#kt_new_password_form").attr("hidden", "hidden");
    $("#newpasswdenunc").text(
      "Por favor, ingrese los datos a continuación para establecer su nueva contraseña"
    );
    let time_minutes = "5";
